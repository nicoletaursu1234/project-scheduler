export const EVENTS = [
  ...
  // },
  {
    id: 7,
    title: "Event 7",
    startDateTime: new Date("2021 5 4 09:00"),
    endDateTime: new Date("2021 5 5 09:20"),
    admin_id: [3],
  },
  {
    id: 8,
    title: "Event 8",
    startDateTime: new Date("2021 5 1 13:00"),
    endDateTime: new Date("2021 5 16 14:00"),
    admin_id: [4, 3],
  },
  {
    id: 9,
    title: "Event 9",
    startDateTime: new Date("2021 5 1 10:00"),
    endDateTime: new Date("2021 5 3 11:00"),
    admin_id: [4],
  },
